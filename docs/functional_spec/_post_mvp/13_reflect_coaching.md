...
| 다음 화면 | 11 (확정 후 `coaching_insights` 저장) |
...
| 버전 | 날짜 | 변경 내용 |
| --- | --- | --- |
| v1.3 | 2026-05-09 | schema v0.7.2 정합성 정렬: **1번 화면 개요 다음 화면** — 옛 테이블명 잔존 정리 (`insight_history` → `coaching_insights`). v1.1에서 본문은 정리됐으나 1번 표 한 곳에 옛 명칭이 남아있어 일괄 정렬. |
