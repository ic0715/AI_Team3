...
| 다음 화면 | 12 회고 (탭바 / 타임라인 [회고하기] 버튼 / 메모 유도 카드) / 14 히스토리 (탭바) / 15 프로필 (탭바) |
...
홈(active) / 회고 / 히스토리(📚) / 프로필 — **4탭 고정** (update0613: 히스토리 탭 추가).
...
| v1.6 | 2026-06-13 | **[update0613 — 히스토리 탭 추가]** **3.7 탭바** 홈/회고/프로필 3탭 → **홈/회고/히스토리(📚)/프로필 4탭**. **§1 다음 화면**에 14 히스토리(탭바) 추가. 14 히스토리(인터뷰 보관함) 신규 구현 반영 — 상세 `14_history.md`. |
