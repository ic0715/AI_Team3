...
홈 / 회고 / 히스토리(📚) / 프로필(active) — **4탭** (update0613: 히스토리 탭 추가).
...
| v1.6 | 2026-06-13 | **[update0613 — 히스토리 탭 추가]** **3.9 탭바** 3탭 → **4탭**(홈/회고/히스토리(📚)/프로필(active)). 14 히스토리(인터뷰 보관함) 신규 구현 반영 — 상세 `14_history.md`. 동작/로직 변경 없음. |
