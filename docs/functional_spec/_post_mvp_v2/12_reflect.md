...
- 영역 구성 (위→아래 순서):
  1. 안내 카드 ("오늘의 느낌을 짧게 기록하고, 다음 주는 AI 코치와 함께 정해요")
...
- 상단: `"💡 오늘의 느낌을 짧게 기록하고, 다음 주는 AI 코치와 함께 정해요"` (12px, accent, weight 700)
- 본문: `"오늘 액션을 실행하면서 느낀 점을 메모로 남겨두세요. 한 주를 마무리할 때쯤 AI 코치와 다음 주 액션을 정해보세요."` (12px, ink-soft)
